  ...
  signup: {
    ...
    handler: async function(request, h) {
      try {
        ...
        console.log(user);
    //    console.log(request.cookieAuth.id + "cookieAuth.id pre set")
        request.cookieAuth.set({ id: user._id });
    //    console.log(request.cookieAuth.id + "cookieAuth.id post set")
   //     console.log("sign up auth.cred id " + request.auth.credentials.id );
